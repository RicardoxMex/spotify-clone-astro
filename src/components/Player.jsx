...
const SongControl = ({ audio }) => {
    ...
    useEffect(() => {
        audio.current.addEventListener('timeupdate', handerTimeUpdate)

        return () => {
            audio.current.removeEventListener('timeupdate', handerTimeUpdate)
        }
    }, [])

    const handerTimeUpdate = () => {
        ...
        <div className="flex flex-row justify-between w-full px-1 z-50">
            ...
            <div className="grid place-content-center gap-4 flex-1">
                <div className="flex justify-center flex-col items-center">
                    <button className="bg-white rounded-full p-2" onClick={handlerClick}>
